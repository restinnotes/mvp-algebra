...
export const MindmapSyllabus: KnowledgeNode[] = [
    {
        ...
        children: [
            { id: "kn_base_001", name: "实数运算与科学记数法", level: 2, description: "掌握绝对值、根号运算及大数的科学表示。" },
            { id: "kn_base_002", name: "分式与二次根式化简", level: 2, description: "掌握复杂代数式的变形技巧与分母有理化。" }
        ]
    },
    {
        id: "root_algebra",
        ...
        children: [
            {
                ...
                children: [
                    { id: "kn_alg_001", name: "一元二次方程判别式应用", level: 3, description: "利用 Δ 判定根的情况，并与系数关系结合。" },
                    { id: "kn_alg_002", name: "正反比例函数解析式", level: 3, description: "确定比例系数 k 及其几何意义（k 的绝对值与面积）。" }
                ]
            },
            {
                id: "sub_parabola",
        ...
        children: [
            {
                ...
                children: [
                    { id: "kn_geo_001", name: "相似三角形判定与性质", level: 3, description: "掌握‘A’字型、‘X’字型等经典相似模型的归纳。" },
                    { id: "kn_geo_002", name: "向量分解与平行向量表示", level: 3, description: "掌握几何向量的加减法法则及合成分解。" }
                ]
            },
            {
                id: "sub_coords",
    ...
    },
    {
        ...
        children: [
            { id: "kn_stat_001", name: "众数、中位数与加权平均", level: 2, description: "准确理解统计量在不同分布下的描述意义。" },
            { id: "kn_stat_002", name: "树状图与列表法求概率", level: 2, description: "对两步或多步随机事件进行穷举分析。" }
        ]
    }
];
