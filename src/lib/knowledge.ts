// Cloudflare Pages strictly enforces the Edge runtime. Next.js Edge runtime static analysis
// (via @cloudflare/next-on-pages) strictly prohibits top-level native Node.js imports.
// Using a dynamic require wrapper inside a try-catch blocks the static analyzer from failing the build.
