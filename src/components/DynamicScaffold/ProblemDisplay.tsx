    ...
    return (
        <div className="flex-1 bg-[#1a1c23] border border-white/5 rounded-2xl p-6 flex flex-col shadow-lg overflow-y-auto relative">
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-white/5">
                ...
                <label className="cursor-pointer flex items-center gap-2 px-3 py-1 bg-white/5 hover:bg-white/10 text-white/60 text-xs rounded-lg transition-all focus-within:ring-2 focus-within:ring-indigo-500/50">
                    <input type="file" className="sr-only" accept="image/*" onChange={handleProblemUpload} disabled={isDecomposing} />
