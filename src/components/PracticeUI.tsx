                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    disabled={page === 1}
                                    aria-label="上一页"
                                    className="p-2 rounded-lg bg-white/5 border border-white/10 disabled:opacity-20 hover:bg-white/10 transition-all text-white/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50"
                                >
                                    <ChevronLeft size={18} />
                                </button>
                                        ...
                                        if (p === 1 || p === totalPages || Math.abs(p - page) <= 1) {
                                            return (
                                                <button
                                                    ...
                                                    className={`w-8 h-8 rounded-lg text-xs font-bold transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 ${page === p ? 'bg-indigo-600 text-white shadow-lg' : 'bg-white/5 text-white/40 hover:bg-white/10'}`}
                                                >
                                                    {p}
                                                </button>
                                            );
