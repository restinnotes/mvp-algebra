...
export default function PracticeUI() {
    ...
    // ⚡ Bolt: Use a pre-calculated Map for O(1) lookups of KPs instead of O(n) array.find() inside loops.
    // This reduces the filtering time complexity from O(N*M) to O(N+M) and prevents main thread blocking.
    const kpMap = useMemo(() => {
